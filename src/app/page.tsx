...
export default function Home() {
  ...
  useGSAP(() => {
    ...
    // Simple fade effect for hero section on scroll (no scaling or complex animations)
    ...
    <div ref={containerRef} className="min-h-screen relative overflow-x-hidden">
      ...
      >
        <motion.p
          ...
          className="text-sm md:text-base text-purple-300 text-center mb-4 font-medium"
        >
        ...
        <div className="text-center mb-8">
          ...
          <span className="text-sm md:text-base text-purple-300 ml-2">
        ...
        >
          <button
            ...
            className="px-6 py-3 bg-purple-600 text-white rounded-full font-medium shadow-lg transition-all duration-200 hover:bg-purple-700 hover:scale-105"
          >
            View Projects
          </button>
          <button
            onClick={() => scrollToSection('contact')}
            className="px-6 py-3 border-2 border-purple-500 text-purple-400 rounded-full font-medium transition-all duration-200 hover:border-purple-400 hover:scale-105"
          >
            Contact Me
          </button>
        </div>
      ...
      <section data-section="projects" className="min-h-screen py-20 px-4 md:px-8 relative">
        ...
        >
          {projects.map((project) => (<motion.div
            ...
            className="group bg-white dark:bg-gray-800/50 rounded-xl overflow-hidden shadow-lg backdrop-blur-sm border border-gray-200 dark:border-gray-700 cursor-pointer"
          ...
          ><div className="h-48 bg-gradient-to-br from-purple-400 to-pink-500 relative overflow-hidden flex items-center justify-center">
            ...
            >                <h3 className="text-xl font-semibold mb-2 group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors duration-200 flex items-center gap-2">
                {project.title}                  <span className="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-full text-xs font-normal">
                  {project.status}
                </span>
              </h3>
              ...
              <motion.div
                className="mt-4 text-purple-600 dark:text-purple-400 font-medium group-hover:text-purple-700 dark:group-hover:text-purple-300 transition-colors duration-200"
                whileHover={{ x: 5 }}
              >
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                          {selectedProject.title}                          <span className="px-2 py-0.5 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-full text-xs font-normal">
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                      {selectedProject.technologies.map((tech, index) => (
                        <motion.div
                          ...
                          className="p-3 bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-lg text-center"
                        >
                  ...
                  <div className="flex gap-4 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 px-6 py-3 bg-purple-600 text-white rounded-lg font-medium shadow-lg transition-all duration-200 hover:bg-purple-700 flex items-center justify-center gap-2"
                    >
                    ...
                    <motion.button
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                      className="flex-1 px-6 py-3 border-2 border-purple-500 text-purple-600 dark:text-purple-400 rounded-lg font-medium transition-all duration-200 hover:border-purple-400 flex items-center justify-center gap-2"
                    >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-3 px-8 py-4 bg-gradient-to-r from-purple-600 to-blue-600 text-white rounded-full font-medium shadow-lg transition-all duration-200 hover:shadow-xl"
            >
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-3 px-8 py-4 border-2 border-purple-500 text-purple-600 dark:text-purple-400 rounded-full font-medium transition-all duration-200 hover:border-purple-400 hover:bg-purple-50 dark:hover:bg-purple-900/20"
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
