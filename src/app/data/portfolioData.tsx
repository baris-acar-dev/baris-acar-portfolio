...
export const technologies = [
  ...
  { name: "Adobe AE", icon: AdobeAEIcon },
];

export const languages = [
  { language: "Turkish", level: "Native", context: ["All Contexts"] },
  { language: "English", level: "Proficient", context: ["Professional", "Technical", "Conversational"] },
  { language: "German", level: "Elementary", context: ["Basic Conversation"] },
  { language: "Japanese", level: "Learning", context: ["Basic Conversation"] },
  { language: "Spanish", level: "Learning", context: ["Basic Conversation"] }
];
